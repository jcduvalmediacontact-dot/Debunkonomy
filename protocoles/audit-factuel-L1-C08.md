...
| § 1 | Les dépôts naissent aussi d'achats d'actifs ; toutes les monnaies n'ont pas pour contrepartie une dette privée portant intérêt | F | S1, p. 16 |
...
| § 4 | La dette publique est dans le même système monétaire mais n'est pas un crédit bancaire ; un titre public crée des dépôts si une banque l'achète | F, D | S1, p. 16 |

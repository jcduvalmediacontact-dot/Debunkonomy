...
## A43 (3b), CONDITION (2) — LES OBLIGATIONS DES EXCÉDENTAIRES SONT AUTOMATIQUES, ET AUCUNE CHARGE N'EST PRÉLEVÉE, 2026-09-17

**DEUX DÉCISIONS DE L'AUTEUR, prises sur la voie recommandée.** **(1)** Les obligations des pays excédentaires sont **automatiques, sans vote d'activation** : leur parité se réévalue selon la règle de révision de l'auteur, comme celle des déficitaires se dévalue, et l'excès au-delà du plafond est recyclé vers les déficitaires ; l'institution les exécute dans ses comptes, et l'adhésion vaut consentement préalable. **(2) Aucune charge n'est prélevée sur les soldes**, ni débiteurs ni créditeurs ; le financement des allocations solidaires passe à l'émission, sous la règle d'émission et le reflux.

**CE QUE CELA RETIRE, ET L'AUTEUR L'A CHOISI EN LE SACHANT.** L'ordre d'intervention du 2026-09-09 comportait des « prélèvements progressifs sur les positions persistantes » ; la solution de référence de la compensation symétrique parlait d'« obligations graduées ». **Les deux sont retirés.**

### CE QUE DISENT LES PRÉCÉDENTS, LUS SUR PIÈCES

**LE PLAN KEYNES DE 1943** — `2026-09-15/c10/S6-imf-elibrary-keynes-proposals.html`, SHA-256 72A4C667FE33867CC636D7BF63E5F55EEBCDB4BED2F3EB482344414E8A3D3633, reproduction du document dans l'histoire du Fonds, volume 3. **La seule obligation automatique du créancier était la charge** : « A member State shall pay to the Reserve Fund of the Clearing Union a charge of 1 per cent, per annum on the amount of its average balance in bancor, whether it is a credit or a debit balance, in excess of a quarter of its quota » ; et même elle pouvait être levée, « The Governing Board may, at its discretion, remit the charges on credit balances ». **La réévaluation était laissée à sa décision** : l'excédentaire « shall discuss with the Governing Board (but shall retain the ultimate decision in its own hands) what measures would be appropriate to restore the equilibrium of its international balances », dont « The appreciation of its local currency in terms of bancor ». **Le débiteur, lui, pouvait se la voir imposer** : « a stated reduction in the value of the member's currency, if it deems that to be the suitable remedy ».

**LES STATUTS DU FONDS, ARTICLE VII** — `2026-09-17/condition-2/imf-articles-VII-scarce-currencies-9781513521244-ch07.html`, SHA-256 4EA19710967237C57FBB6306510F893579BBE9D73E461649BB87E477CED5802B. La clause de la monnaie rare se déclenche sur les avoirs du Fonds, non sur l'excédent du créancier — « If it becomes evident to the Fund that the demand for a member's currency seriously threatens the Fund's ability to supply that currency » — et **elle n'oblige pas le créancier : elle autorise les autres**, « A formal declaration under ( a ) above shall operate as an authorization to any member, after consultation with the Fund, temporarily to impose limitations on the freedom of exchange operations in the scarce currency ».

**LA PROCÉDURE EUROPÉENNE CONCERNANT LES DÉSÉQUILIBRES MACROÉCONOMIQUES** — règlement (UE) n° 1176/2011, `2026-09-17/condition-2/32011R1176.pdf`, SHA-256 83DBF89696AB4948B1AF465701ED28F767A7F900125C141F8B48656A4E05B36C ; règlement (UE) n° 1174/2011, `2026-09-17/condition-2/32011R1174.pdf`, SHA-256 573B491B7E80AB35805EB175E36430E1430960B27BD832A6E39B35E0253F07D8 ; Cour des comptes européenne, rapport spécial n° 3/2018, `2026-09-17/condition-2/SR_MIP_EN.pdf`, SHA-256 60F240E1ED590B9CEE1C026D3AED2ED334D46A98A20134525BDC8763CB4AC3AC. **L'asymétrie est écrite dans le texte** : « The assessment of Member States showing large current-account deficits may differ from that of Member States that accumulate large current-account surpluses. » (page PDF 4). **La sanction est chiffrée** : « The interest-bearing deposit or the annual fine recommended by the Commission shall be 0,1 % of the GDP in the preceding year of the Member State concerned. » (page PDF 3). **Et elle ne s'est jamais déclenchée** : « It is noteworthy that the Commission has never recommended activation of the excessive imbalance procedure, despite the fact that, since the start of the MIP in 2012, several Member States have been identified as having excessive imbalances over a prolonged period. » (page PDF 8). **La disposition qui contraint n'a pas sauté : elle a été adoptée, puis jamais activée.**

**L'UNION EUROPÉENNE DES PAIEMENTS** — voir la section du 2026-09-16 : règlement dur pour les débiteurs, créanciers au-delà du quota seulement « urged » à libéraliser leurs importations.

### CE QUE DIT LE MODÈLE

`python modeles/nemo_soldes.py`, section finale `comparer_obligations`, vérifiée par la section I de `modeles/test_nemo_soldes.py`. Sous la règle de révision de l'auteur ; rien n'est calibré. **Les paramètres ajoutés reproduisent le modèle à l'identique quand ils restent par défaut**, contrôle fait contre la version commitée sur quarante jeux, puis inscrit au test.

**(1) LA RÉÉVALUATION DE L'EXCÉDENTAIRE FAIT L'ESSENTIEL.** Contraction du déficitaire de S0 à S3 : 2496 sans obligation du créancier, 2496 avec la charge seule, 2378 avec le plafond seul, **1432 avec la réévaluation seule, soit 43 % de moins**, 1432 avec les trois. **L'instrument que Keynes laissait à la décision du créancier est celui qui soulage le débiteur ; celui qu'il rendait automatique n'en soulage aucun.**

**(2) CHAQUE PÉRIODE D'ATTENTE AVANT ACTIVATION RETIRE DU SOULAGEMENT** : 1432 → 1541 → 1721 → 2044 → 2496 pour 0, 2, 4, 8, 20 périodes. Quatre périodes en font perdre 27 %, huit 58 % ; une attente égale à l'horizon revient à l'obligation délibérative. **Une obligation qu'il faut activer par un vote glisse vers le cas européen.**

**(3) LES CHARGES NE SOULAGENT PAS, ET ELLES ENFONCENT.** Obligations automatiques, en S4, la perte durable d'un débouché : charges des deux côtés, contraction 1641 et 8 dépassements ; charges des seuls excédents, 1414 et 7 ; **aucune charge, 1040 et 0 dépassement.** La charge sur le débiteur le contracte davantage — en S4 il en paie 380 avec des charges des deux côtés ; la charge sur l'excédentaire détourne vers l'institution ce que le recyclage lui aurait prêté. **La conversion, qui verse l'excès à l'institution, ne soulage pas le déficitaire comme le recyclage** : 1486 en S4.

**LE PRIX DU CHOIX, ET IL EST PUBLIÉ AVEC LUI.** Sans charge, l'institution ne perçoit rien : son solde cumulé est de −1233, contre −635 avec des charges sur les excédents et −249 avec des charges des deux côtés. Avec les trois obligations et des charges des deux côtés, les charges des excédentaires couvraient 46 % des allocations. **Dans NEMO, ce solde est une émission : il relève de la règle d'émission et du reflux — F1 —, et la condition (4) change donc de nature, d'une question de prélèvement à une question d'émission.**
...
## A43 (3b), CONDITION (4) — QUI FINANCE LES GUICHETS ET LA RECONVERSION, 2026-09-17

### DEUX DÉCISIONS DE L'AUTEUR, PRISES SUR LA VOIE RECOMMANDÉE

**(D75) LE DÉCOUVERT APURÉ.** L'institution verse par émission au moment du besoin — allocations solidaires et reconversion d'un pays qui perd un débouché ; le découvert ainsi ouvert est apuré dans le temps par l'excédent du reflux du Symposium, au titre de la formule d'affectation (EXCEDENT-DU-SYMPOSIUM). **Le besoin structurel non apuré est déclaré émission permanente et compté dans F1.** Deux autres voies étaient posées et sont écartées : l'émission pure, sans apurement ; le reflux seul, sans émission.

**(D76) LE DÉMURRAGE DE REFLUX EST MAINTENU.** D71 visait les prélèvements progressifs sur les positions, qui sont un instrument d'ajustement. Le démurrage uniforme sur les soldes institutionnels en unités reste un instrument de reflux (A36), celui qui alimente l'excédent du Symposium. **Le registre est corrigé : « aucune charge graduée sur les positions ».**

### CE QUE DISENT LES PIÈCES

**LE PLAN KEYNES D'AVRIL 1943** — même pièce que pour la condition (2), `2026-09-15/c10/S6-imf-elibrary-keynes-proposals.html`, SHA-256 72A4C667FE33867CC636D7BF63E5F55EEBCDB4BED2F3EB482344414E8A3D3633 ; les passages cités sont ceux de la version (B), « Proposals for an International Clearing Union (April 1943) », et non du brouillon de 1942 que la pièce reproduit aussi. **Le découvert apuré y figure**, pour les organismes internationaux de secours et de reconstruction : « The Union might set up a clearing account in favour of international bodies charged with post-war relief, rehabilitation and reconstruction. » ; « For it might supplement contributions received from other sources by granting preliminary overdraft facilities in favour of these bodies, the overdraft being discharged over a period of years out of the Reserve Fund of the Union, or, if necessary, out of a levy on surplus credit balances. » **Le précédent vaut pour le mécanisme, et il faut dire d'où Keynes tirait l'apurement** : du Fonds de réserve, que les charges sur les soldes alimentaient — citées plus haut, condition (2) —, et au besoin d'un prélèvement sur les soldes créditeurs excédentaires. **D71 a retiré ces deux sources.** Dans NEMO, l'excédent du reflux tient la place du Fonds de réserve, et aucune source de secours n'est prévue.

**Le même texte nomme le remède au problème que le modèle révèle plus bas, et la raison pour laquelle Keynes l'a écarté** : « For the appropriate provision might be to require the eventual cancellation or compulsory investment of persistent bancor credit balances accumulating in excess of a member’s quota; and, however desirable this may be in principle, it might be felt to impose on creditor countries a heavier burden than they can be asked to accept before having had experience of the benefit to them of the working of the plan as a whole. »

**LES STATUTS DU FONDS MONÉTAIRE INTERNATIONAL, ARTICLE XVIII** — `2026-09-17/condition-4/imf-articles-XVIII-sdr-allocation-ch18.html`, SHA-256 8DF6E87A102A6A8DE1EB6619A86E6438B90CA4E30D5405E6148A8C7A45B8152D, édition de 2020 (ISBN 9781513521244). L'allocation d'un actif de réserve créé par une institution internationale existe en droit, sous la double contrainte qui est celle de F1 : « In all its decisions with respect to the allocation and cancellation of special drawing rights the Fund shall seek to meet the long-term global need, as and when it arises, to supplement existing reserve assets in such manner as will promote the attainment of its purposes and will avoid economic stagnation and deflation as well as excess demand and inflation in the world. » **Mais elle n'est ni ciblée ni automatique** : « The rates at which allocations are to be made shall be expressed as percentages of quotas on the date of each decision to allocate. » ; « The percentages shall be the same for all participants. » ; et « An eighty-five percent majority of the total voting power shall be required for decisions under Section 2(a), (b), and (c) or Section 3 of this Article except for decisions under Section 3 with respect to a decrease in the rates of allocation. » **Le précédent couvre l'émission ; il ne couvre ni un versement au besoin d'un pays, ni l'absence de vote.**

### CE QUE MONTRE LE MODÈLE

`python modeles/nemo_soldes.py`, section finale `comparer_financement_guichets`, vérifiée par la section K de `modeles/test_nemo_soldes.py`. `jouer` tient désormais un registre du découvert — ce que l'institution verse sans remboursement, et ce qu'un flux d'apurement en retire ; **il ne change aucune trajectoire**, contrôle fait contre la version commitée, cinq flux d'apurement compris, puis inscrit au test. Configuration complète de l'auteur, quarante périodes. **Le reflux n'est pas modélisé** : son repère, le besoin moyen par période sur les cinq scénarios, vaut 11,14 ; il est tiré des besoins eux-mêmes, et S2 en fait l'essentiel.

**(1) CE QUE LES GUICHETS VERSENT SANS REMBOURSEMENT** : 59 en S0, 171 en S1, 1514 en S2, 189 en S3, 296 en S4 dont 240 de reconversion ; au total 2228, dont 68 % pour le seul choc structurel.

**(2) SUR UN CHOC PASSAGER, LE DÉCOUVERT SE RÉSORBE, D'AUTANT PLUS LENTEMENT QUE LE REFLUX EST FAIBLE.** Au repère, pics de 96, 117 et 206 en S1, S3 et S4, résorbés en 16, 17 et 28 périodes depuis le premier versement ; S0 ne reporte rien d'une période à l'autre. À la moitié du repère, 31 et 34 périodes pour S1 et S3, et **la perte d'un débouché n'est plus apurée dans l'horizon** (reste 96) ; au double, 8, 9 et 17 périodes.

**(3) SUR UN CHOC STRUCTUREL, LE DÉCOUVERT NE SE RÉSORBE QUE SI LE REFLUX DÉPASSE LE FLUX DU BESOIN LUI-MÊME** — 37,8 par période, 3,4 fois le repère : reste 1113 au repère, 712 au double, apuré au quadruple. **Au-delà, c'est le reflux qui finance le besoin en permanence : un financement en aval, sur une recette prélevée, dont L1.C19 § 2 distingue précisément la proposition. En deçà, c'est une émission permanente, et D75 la compte dans F1.**

**(4) LE REFLUX SEUL MANQUE AU MOMENT DES CHOCS.** Mesure de calendrier sur la trajectoire financée, non simulation d'un régime sans émission : au repère, il manquerait 51, 72 et 148 en S1, S3 et S4, et 1068 en S2. Pour que rien ne manque sans fonds préalable, il faudrait un flux de 16,3, 18,4 et 22,5 par période — 3,8, 3,9 et 3,0 fois le besoin moyen de chaque scénario ; au flux propre du scénario, un fonds constitué d'avance de 120, 137 et 196, soit 70, 73 et 66 % du besoin total. **C'est la procyclicité dont la conception du pilote, le 2026-09-09, demandait déjà un régime d'urgence.**

**(5) L'ÉMISSION NE DISPARAÎT PAS : ELLE ABOUTIT CHEZ L'EXPORTATEUR DES BIENS ESSENTIELS.** En S2, l'allocation sert 100 % de l'essentiel du pays pauvre contre 81 % sans elle, et ramène sa contraction de 581 à 53 ; sa parité reste à 1,00 contre 1,28 sans elle — **il n'ajuste plus par le change**, et ses exportations sont de 1606 contre 1835. Ce qu'elle émet aboutit chez l'excédentaire : son solde final est de 1073 contre 259 à quarante périodes, **2862 à quatre-vingts** ; sa réévaluation est à la butée, le recyclage ne trouve aucun destinataire à quarante périodes — l'allocation a déjà couvert le déficit —, et **son solde dépasse le plafond dès la période 38, puis à chaque période jusqu'à la quatre-vingtième**. Sans allocation, c'est le pays pauvre qui passe sous son plancher, 24 fois sur quarante périodes. **L'émission permanente d'un besoin structurel devient l'accumulation permanente de l'exportateur, et aucun des instruments retenus pour le créancier ne l'arrête : ni la réévaluation, bornée par la butée (D69), ni le recyclage, qui ne ramène jamais le solde sous le plafond, ni la charge, retirée (D71).**

### LE PRIX, ET CE QUE LE MODÈLE NE DIT PAS

**LE REGISTRE DU DÉCOUVERT N'EST PAS LE SOLDE DE L'INSTITUTION.** Dans les comptes de compensation, le solde négatif de l'institution a toujours pour contrepartie les soldes positifs des pays — c'est le contrôle C1. Apurer le découvert, c'est réduire ces soldes quelque part : en S1, au repère, le registre revient à zéro quand l'institution reste à −171. **Le modèle compte ce que le reflux aurait à retirer ; il ne le retire pas, et ne dit pas qui le paie.** Si le démurrage maintenu par D76 atteint les soldes de compensation, il frappe surtout l'exportateur chez qui l'émission aboutit, et tient, uniforme, une part du rôle que Keynes donnait aux charges ; **cette assiette n'est pas tranchée.**

**Rien n'est calibré, le reflux n'est pas modélisé, et l'inflation pas davantage** : le modèle ne dit pas ce que deviennent les soldes que l'exportateur accumule.
...
## TRANCHE 3 — QUATRE DÉCISIONS DE L'AUTEUR : D92, D93, D94 ET D101, 2026-09-17

L'alignement de L1.C17 à L1.C30 est préparé (`protocoles/architecture-tranche-3.md`) et sa feuille de décisions numérote D92 à D107. L'auteur a tranché le même jour les quatre questions qui débloquaient le plus, chaque fois sur la voie recommandée.

**(D92) LA FORME DE L'UNITÉ EST EXPOSÉE, NON TRANCHÉE, DANS LES CHAPITRES RÉÉCRITS ; LA FICHE DE SPÉCIFICATION DE L'UNITÉ DEVIENT LE PROCHAIN CHANTIER DU PASSIF.** Six chapitres raisonnent sur l'unité du livre — nominative, non cessible, détruite à la conversion — alors que la priorité de modélisation est une unité de réserve tenue par les banques centrales (A37) et que la compensation de (3b) fait tenir des positions qui se remboursent ou s'annulent. Chaque réécriture expose ces trois branches sans conclure. La pièce qui les départagerait, et que le corpus s'est réclamée sans la produire (L10.C06 ; L20.C02), est désormais le chantier suivant d'A35b : droits du détenteur, obligations de l'émetteur, règle de conversion, extinction, détenteurs autorisés, sort en cas de sortie d'un membre. Écartés : l'unité de réserve comme référence du Livre 1, qui aurait tranché A37 de fait ; l'unité du livre comme référence.

**(D93) L1.C27 EXPOSE, SANS TRANCHER, SI LE FINANCEMENT RÉGÉNÉRATIF EST ENCORE UN CANAL DE RÉÉQUILIBRAGE EXTÉRIEUR**, en disant que seule la voie des guichets d'A45 est décrite par des pièces arbitrées. La thèse du livre — les émissions régénératives rééquilibrent les échanges — reste ouverte : le modèle ne l'a jamais jouée. Écartés : le rééquilibrage par le seul Exchange Standard, le complément à (3b), la seule voie des guichets.

**(D94) LE REFLUX DU DISPOSITIF RETIRE LA MONNAIE DE LA CIRCULATION ; IL NE LA DÉTRUIT PAS.** Les chapitres réécrits l'écrivent ainsi et renvoient le sort de ce qui est retenu à EXCEDENT-DU-SYMPOSIUM, conformément à A2 bis. **Appliqué au vocabulaire** : l'entrée `reflux_monetaire` s'ouvrait sur « Destruction de la monnaie après sa création » ; elle définit désormais un retrait de la circulation, qui détruit la monnaie dans le régime de crédit et la retient sans la détruire dans le reflux collectif. Écartés : deux étages, destruction de dépôts puis rétention, décrivant un circuit encore à préciser ; « destruction » jusqu'à la formule d'affectation.

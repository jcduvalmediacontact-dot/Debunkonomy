...
**Les seize décisions de la tranche 3 sont rendues.** Le dossier d'édition que D107 commande est produit le 2026-09-17 : `protocoles/dossier-edition-L1-D107.md`, **vingt-six points sur dix chapitres**, extraits par script des sections « Questions à l'auteur » puis relus. Il ajoute trois choses que la validation en bloc aurait tues : **huit sources déclarées, toutes `a_requalifier`, sortiraient du Livre 1** si les recommandations sont suivies, plus une dizaine de sources non déclarées des annexes de L1.C29 ; **trois recommandations ajoutent du travail** au lieu d'en retirer ; et **quatre points ne sont pas éditoriaux** — L1.C29 Q6 corrige un énoncé qui contredit une précision de l'auteur, L1.C30 Q5 engage P57 et une spécification hors du chapitre, L1.C18 Q7.6 crée une tâche au Livre 7, L1.C24 Q4 n'est applicable qu'après une recherche. **La réécriture attend la lecture de ce dossier.**

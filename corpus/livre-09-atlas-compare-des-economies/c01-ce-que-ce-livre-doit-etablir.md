...
verifications_en_attente:
  - "AUCUNE SOURCE N'EST OUVERTE POUR CE LIVRE, et aucun chapitre n'est écrit.
     **Ce chapitre est une AMORCE** : il enregistre ce que le registre assigne au
     matricule 9 et ne l'instruit pas. **Il ne verse aucun résultat au corpus
...
::etat:: **AMORCE. Aucun chapitre de ce livre n'est écrit, et aucune source n'est ouverte pour lui.** Ce chapitre existe pour que le dossier du matricule 9 figure dans l'arborescence, **et il n'instruit rien.**

## 1. Ce que le registre assigne à ce matricule

::etat:: **Titre** : Atlas comparé des économies du monde. **Collection** : cahier-comparatif. **Statut du livre** : exploratoire [S1].

::etat:: **Fonction** [S1] : Constituer des fiches nationales comparables et actualisables, puis produire des synthèses régionales et une matrice d'adaptation à NEMO IMS

::etat:: **Motif inscrit au registre** : discipline — économie comparée.

::etat:: **Motif inscrit au registre** : rouage — conditions d'adaptation nationale du dispositif.
...
::etat:: **Le matricule 9 est permanent.** Il ne se réattribue pas, ne s'insère pas et ne se renumérote pas, même si ce livre n'est jamais écrit (convention § 3).

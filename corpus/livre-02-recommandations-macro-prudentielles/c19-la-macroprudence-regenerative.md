---
chapitre: L2.C19
titre: "La macroprudence régénérative"
livre: 2
langue: fr
...
verifications_en_attente:
  ...
  - "LE TABLEAU DE BORD INTÉGRÉ ET L'ÉCOSYSTÈME D'INSTRUMENTS (section 5 de
     l'épisode 12) NE SONT PAS DÉPOUILLÉS. **C'est la pièce qui articulerait
     les dix déplacements en un dispositif opérable**, et le corpus ne l'a pas
     lue — alors que L1.C28 a établi qu'un tableau de bord à six familles
     N'ARBITRE PAS."
  - "LE COMPTE ÉTABLI ICI EST UN JUGEMENT DU CORPUS, NON UNE MESURE. Répartir
...
::etat:: Ce chapitre clôt l'examen des dix déplacements **et en dresse le compte.**

## 1. La formule de rassemblement est la bonne

::etat:: **L'épisode 12 les rassemble ainsi** [S1] : « **Chacun étend un domaine spécifique de la macroprudence défensive vers sa dimension régénérative correspondante.** Ensemble, ils constituent l'architecture cohérente de la macroprudence régénérative. »

::hypothese:: **Après dix chapitres d'épreuve, le corpus tient cette formule pour exacte, et il tient celle de l'épisode 1 pour fausse.** Les deux paradigmes ne s'excluent pas ; **le second étend le premier**, et le Cahier l'écrit lui-même à la fin de la série qu'il a ouverte en disant le contraire.

## 2. Le compte

::etat:: **Le corpus classe les dix selon ce que l'épreuve a montré.**

| | Déplacement | Ce que l'épreuve donne |
|---|---|---|
...
## 3. Le résultat central du livre

::hypothese:: **Six déplacements sur dix prolongent un mouvement déjà engagé** — les numéros 1 à 6 —, souvent par des auteurs nommés, parfois dix ans plus tôt. **Le Cahier ne les revendique comme tels dans aucun cas.**

::hypothese:: **Un septième est réel et n'a aucun porteur.** La résilience territoriale produit un diagnostic **que personne n'est tenu de commander ni d'exécuter.**
...
::etat:: **La feuille de route** [S2] : « Cette série macroprudentielle n'est pas un point final. Elle est **un point de départ** », et elle appelle un travail collectif « dont l'ampleur **excède les capacités individuelles** ou même d'une organisation isolée ».
...
::etat:: **Le tableau de bord intégré et l'écosystème d'instruments — section 5 de l'épisode 12 — ne sont pas dépouillés.** C'est **la pièce qui articulerait les dix déplacements en un dispositif opérable**, et le corpus ne l'a pas lue.

::hypothese:: **Le manque est d'autant plus gênant que L1.C28 a établi qu'un tableau de bord à six familles n'arbitre pas.** Si la section 5 fournit une règle d'arbitrage, **elle répond à une objection ouverte du corpus** ; si elle n'en fournit pas, **l'objection est confirmée pour la seconde fois.** Dans les deux cas, il fallait la lire.

::etat:: **Trois des quatre missions du think tank ne sont pas dépouillées non plus.**

::etat:: **Et le compte de la section 2 est un jugement, non une mesure.** Répartir dix déplacements entre « extension » et « sans précédent » suppose de savoir ce que la doctrine contient ; **le corpus tient quatre textes doctrinaux.** **Un cinquième pourrait déplacer une ligne.**
...
::etat:: **La section qui articulerait les dix déplacements en dispositif opérable n'a pas été lue.**

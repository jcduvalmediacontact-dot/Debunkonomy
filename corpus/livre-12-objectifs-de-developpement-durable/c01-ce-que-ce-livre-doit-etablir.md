...
sources_primaires:
  - ref: S1
    nature: theorie
    reference: "**`corpus/livres.yaml`, matricule 12** — projection du plan directeur de l'auteur. **Titre** : Comment réaliser les ODD avec NEMO IMS ?. **Collection** : cahier-comparatif. **Statut du livre** : candidat. **Fonction assignée** : Évaluer ce que NEMO IMS peut faciliter pour chaque objectif de développement durable, ses limites et les politiques complémentaires nécessaires. **Motifs** : **discipline — politiques de développement**"
...
verifications_en_attente:
  - "AUCUNE SOURCE N'EST OUVERTE POUR CE LIVRE, et aucun chapitre n'est écrit.
     **Ce chapitre est une AMORCE** : il enregistre ce que le registre assigne au
     matricule 12 et ne l'instruit pas. **Il ne verse aucun résultat au corpus
...
::etat:: **AMORCE. Aucun chapitre de ce livre n'est écrit, et aucune source n'est ouverte pour lui.** Ce chapitre existe pour que le dossier du matricule 12 figure dans l'arborescence, **et il n'instruit rien.**

## 1. Ce que le registre assigne à ce matricule

::etat:: **Titre** : Comment réaliser les ODD avec NEMO IMS ?. **Collection** : cahier-comparatif. **Statut du livre** : candidat [S1].

::etat:: **Fonction** [S1] : Évaluer ce que NEMO IMS peut faciliter pour chaque objectif de développement durable, ses limites et les politiques complémentaires nécessaires

::etat:: **Motif inscrit au registre** : discipline — politiques de développement.
...
::etat:: **Le matricule 12 est permanent.** Il ne se réattribue pas, ne s'insère pas et ne se renumérote pas, même si ce livre n'est jamais écrit (convention § 3).

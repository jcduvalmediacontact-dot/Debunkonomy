...
sources_primaires:
  - ref: S1
    nature: theorie
    reference: "**`corpus/livres.yaml`, matricule 16** — projection du plan directeur de l'auteur. **Titre** : Typologie comparée des systèmes et alternatives monétaires. **Collection** : cahier-comparatif. **Statut du livre** : candidat. **Fonction assignée** : Comparer les architectures monétaires selon une grille explicite et situer NEMO IMS parmi les solutions existantes ou proposées. **Motifs** : **discipline — monnaies souveraines, crédit bancaire, monnaies-marchandises, monnaies locales et libres, cryptoactifs, stablecoins, MNBC, unités de compensation, projets supranationaux**"
...
verifications_en_attente:
  - "AUCUNE SOURCE N'EST OUVERTE POUR CE LIVRE, et aucun chapitre n'est écrit.
     **Ce chapitre est une AMORCE** : il enregistre ce que le registre assigne au
     matricule 16 et ne l'instruit pas. **Il ne verse aucun résultat au corpus
...
::etat:: **AMORCE. Aucun chapitre de ce livre n'est écrit, et aucune source n'est ouverte pour lui.** Ce chapitre existe pour que le dossier du matricule 16 figure dans l'arborescence, **et il n'instruit rien.**

## 1. Ce que le registre assigne à ce matricule

::etat:: **Titre** : Typologie comparée des systèmes et alternatives monétaires. **Collection** : cahier-comparatif. **Statut du livre** : candidat [S1].

::etat:: **Fonction** [S1] : Comparer les architectures monétaires selon une grille explicite et situer NEMO IMS parmi les solutions existantes ou proposées

::etat:: **Motif inscrit au registre** : discipline — monnaies souveraines, crédit bancaire, monnaies-marchandises, monnaies locales et libres, cryptoactifs, stablecoins, MNBC, unités de compensation, projets supranationaux.
...
::etat:: **Le matricule 16 est permanent.** Il ne se réattribue pas, ne s'insère pas et ne se renumérote pas, même si ce livre n'est jamais écrit (convention § 3).

...
sources_primaires:
  - ref: S1
    nature: theorie
    reference: "**`corpus/livres.yaml`, matricule 25** — projection du plan directeur de l'auteur. **Titre** : Répartition, besoins essentiels et justice sociale. **Collection** : cahier-disciplinaire. **Statut du livre** : candidat. **Fonction assignée** : Tester qui paie réellement le dispositif et qui reçoit ses bénéfices — ménages, revenus, patrimoine, accès aux besoins essentiels, services publics, inégalités territoriales, travail de soin, acceptabilité politique. **Motifs** : **objection — L11.C09 a découvert la question de l'incidence sans pouvoir la traiter, et A35 la rend décisive : la fonte est modulée par la décision de chacun** ; **arbitrage — A34 : un barème qui dit vrai EXCLUT CEUX QUI NE PEUVENT PAS PAYER, et l'exclusion est maximale là où le signal doit être le plus fort** ; **manque — L5.C09 a enregistré comme un MANQUEMENT que la contrainte de rédaction exigeait des coûts humains et qu'aucun chapitre n'en produit**"
...
verifications_en_attente:
  - "AUCUNE SOURCE N'EST OUVERTE POUR CE LIVRE, et aucun chapitre n'est écrit.
     **Ce chapitre est une AMORCE** : il enregistre ce que le registre assigne au
     matricule 25 et ne l'instruit pas. **Il ne verse aucun résultat au corpus
...
::etat:: **AMORCE. Aucun chapitre de ce livre n'est écrit, et aucune source n'est ouverte pour lui.** Ce chapitre existe pour que le dossier du matricule 25 figure dans l'arborescence, **et il n'instruit rien.**

## 1. Ce que le registre assigne à ce matricule

::etat:: **Titre** : Répartition, besoins essentiels et justice sociale. **Collection** : cahier-disciplinaire. **Statut du livre** : candidat [S1].

::etat:: **Fonction** [S1] : Tester qui paie réellement le dispositif et qui reçoit ses bénéfices — ménages, revenus, patrimoine, accès aux besoins essentiels, services publics, inégalités territoriales, travail de soin, acceptabilité politique

::etat:: **Motif inscrit au registre** : objection — L11.C09 a découvert la question de l'incidence sans pouvoir la traiter, et A35 la rend décisive : la fonte est modulée par la décision de chacun.

::etat:: **Motif inscrit au registre** : arbitrage — A34 : un barème qui dit vrai EXCLUT CEUX QUI NE PEUVENT PAS PAYER, et l'exclusion est maximale là où le signal doit être le plus fort.

::etat:: **Motif inscrit au registre** : manque — L5.C09 a enregistré comme un MANQUEMENT que la contrainte de rédaction exigeait des coûts humains et qu'aucun chapitre n'en produit.

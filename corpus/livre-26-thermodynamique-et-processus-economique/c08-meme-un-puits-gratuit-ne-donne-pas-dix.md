...
::hypothese:: **Une part du débat sur la richesse des gisements est donc sans objet pour la question que le corpus pose.** Le dispositif ne finance pas des puits : il qualifie des activités dont l'énergie arrive **au point d'usage**. **À cette frontière, la qualité du gisement n'est plus la variable qui commande** — et deux ressources séparées d'un facteur quatre à l'extraction peuvent se retrouver à quelques dixièmes l'une de l'autre à l'usage.

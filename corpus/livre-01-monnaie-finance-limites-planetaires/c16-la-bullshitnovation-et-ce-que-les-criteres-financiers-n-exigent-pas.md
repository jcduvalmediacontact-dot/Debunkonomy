---
chapitre: L1.C16
titre: "La bullshitnovation, et ce que les critères financiers n'exigent pas"
livre: 1
langue: fr
...
- l'offreur retire un avantage économique identifiable de la **non-résolution** du problème par sa prestation : toutes choses égales par ailleurs, atteindre durablement le résultat minimal attendu réduirait cet avantage, au-delà de la seule extinction normale d'un besoin satisfait ;
- à l'horizon retenu, la prestation est établie comme n'atteignant pas le résultat minimal attendu sur ce problème, ou comme l'aggravant, par comparaison avec le contrefactuel fixé.

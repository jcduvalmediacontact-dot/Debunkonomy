...
::etat:: **Les délais.** L'effet d'un ajustement de taux arrive avec des retards longs et variables, de sorte qu'une correction décidée sur l'état observé d'une grandeur agit sur un état qui a déjà changé [S13]. **Aucune règle ne supprime les délais de transmission, de constat ou de recouvrement** : elle supprime seulement le délai de décision.

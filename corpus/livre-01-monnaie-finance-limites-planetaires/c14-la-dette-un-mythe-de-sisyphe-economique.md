---
chapitre: L1.C14
titre: "La dette, un mythe de Sisyphe économique"
livre: 1
langue: fr
...
verifications_en_attente:
  ...
  # SOLDÉE le 2026-09-22 — décision de l'auteur : la phrase est récrite SANS le nombre, aucune pièce n'étant acquise. La borne logique du § 2 reste ; l'argument ne portait pas sur la taille de la part autofinancée. Texte d'origine :
  ...
  # SOLDÉE le 2026-09-22 — DEUXIÈME DES TROIS ISSUES retenue par l'auteur : la proposition est GARDÉE et donnée comme rapportée sans appui ouvert, l'appel [S5] ne couvrant plus que la course vérifiée page PDF 23. La troisième issue — fournir Beschleunigung — aurait été une acquisition, exclue par l'ordre. Le corps ne dit PAS que Rosa emploie « stabilisation dynamique » dans le volume ouvert : ce terme y a zéro occurrence. Texte d'origine :
  ...
  # S3, S4, S8 : DOI confirmés (Crossref). S1 : dates recoupées (manuscrit février 1941, achevé d'imprimer 16 octobre 1942).
  # S7 : recoupé — 57,7 GtCO2e en 2024 ; 2023 révisé à 56,2 GtCO2e dans l'édition 2025 (l'édition 2024 donnait 57,1) : ne pas comparer les deux éditions.
  # S8 : Deep Research donnait « vol. 112, p. 49-59 » — faux ; le volume est 120, p. 32-48 (déjà cité en L1.C08 [S6]).
  # — Objections de l'audit contradictoire (Gemini, 2026-09-03) traitées dans le texte —
  # 1. § 1 : « un emprunt nouveau plus grand » réintroduisait la version arithmétique écartée en L1.C08 § 2. Corrigé — la contrainte est conditionnelle (accumulation des revenus d'intérêts), avec Jackson et Victor [S8] cités pour l'état stationnaire possible.
  # 2. § 2 : l'usure du capital est physique et existe sous tout régime [S10] ; le chapitre isole ce que le régime ajoute (l'amortissement doit être financé par un crédit qui exige un rendement, et l'encours croît).
  # 3. § 3 : les travaux sur revenu et bien-être mesurent une saturation hédonique, sans lien avec la monnaie de crédit ; le chapitre le dit et distingue les deux causes.
...
(*Image : Sophie a créé, il y a douze ans, une menuiserie de trois salariés dans une vallée du sud-ouest — bois local, circuits courts, techniques anciennes. Elle n'a pas monté l'entreprise pour maximiser un profit, mais pour vivre d'un métier et le transmettre. Ses clients sont fidèles ; elle pourrait avoir trouvé un équilibre. Chaque année pourtant, la même côte : outillage à renouveler, stocks à financer, salaires à relever, crédit d'agrandissement à rembourser.*)
...
(*Image : Camille est ministre de la Transition écologique, nommée avec un mandat clair. Elle a été militante avant d'être élue ; elle connaît les rapports du GIEC. Elle passe pourtant ses journées à négocier des dérogations, signer des autorisations, valider des projets, rassurer les marchés.*)
...
::hypothese:: La figure sisyphéenne, une fois établie, se caractérise par trois traits.

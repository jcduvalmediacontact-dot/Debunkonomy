---
chapitre: L1.C29
titre: "Vision globale et chantiers ouverts"
livre: 1
langue: fr
...
verifications_en_attente:
  ...
  - "LES TROIS SCÉNARIOS D'ADVENUE DU CHAPITRE DE CLÔTURE [S5] NE SONT PAS INSTRUITS. Le § 6
     ...
     d'après le Livre 1."
  - "LE RELEVÉ DU REGISTRE AU § 6 EST DATÉ DU 2026-09-20 et doit être recalculé par
     `corpus/controle.py` à chaque révision de fond de ce chapitre. Un nombre écrit à la
     main périmerait en silence, ce que la règle du projet interdit. RECALCULÉ le 2026-09-20
     à la révision de ce jour : 65 entrées (24 arbitrages, 14 falsifieurs, 27 pièces de
     conception manquantes), 18 arbitrées dont 16 par l'auteur et 2 par le corpus, 47
     ouvertes ou orientées, aucun des 14 falsifieurs levé — chiffres INCHANGÉS depuis le
     2026-09-19. AUCUN CONTRÔLE N'IMPOSE CETTE CONCORDANCE : la supervision du 2026-09-19
  ...
  - "LE DÉBITEUR JURIDIQUEMENT IDENTIFIABLE EST UNE OBJECTION À TRANCHER, ET NON UNE
     ...
     formule est PLUS LARGE que ce que [S2] porte : le Cahier décrit un remboursement
     « non pas par un débiteur identifié, mais par l'ensemble des acteurs », ce qui est la
     description d'un mécanisme, non un principe de non-reconnaissance. L'énoncé est donc
     resserré sur le débiteur EN DROIT, conformément à l'arbitrage du porteur restitué au
     § 1, et présenté comme une tension à trancher. CE QUI LA TRANCHERAIT : la revue par un
     comptable national déjà inscrite ci-dessus, à qui la question doit être posée
     explicitement, ou un arbitrage de l'auteur. AUCUNE SOURCE DE CE CHAPITRE NE PORTE LE
     POINT : il est tenu par L10.C06 § 2."
  - "LA CORRECTION DU REPLI EN ANNEXE EST APPLIQUÉE ICI ET DOIT ÊTRE PROPAGÉE. Le § 4
     énonçait qu'à défaut du seul critère de mesure la ressource est portée en annexe.
     L18.C01 § 2 a corrigé cette lecture : le § 12 d'IPSAS 51 est CONDITIONNÉ AU CONTRÔLE,
     et si le contrôle manque il n'y a rien à porter en annexe. Comme ce chapitre établit
     que le contrôle n'est pas acquis, le repli est fermé et non ouvert. À VÉRIFIER : que
     les autres chapitres qui invoquent le repli en annexe portent la même correction —
     relevé non fait, et il sort du périmètre de cette passe."
...
renvois: [L1.C17, L1.C18, L1.C19, L1.C20, L1.C21, L1.C22, L1.C26, L1.C27, L1.C28, L1.C25, L1.C31, L10.C01, L10.C06, L18.C01, L18.C05, L18.C06]
---
...
::etat:: **La réponse du livre est brève et elle nomme un objet.** Sous le titre « Révolution comptable » : « par convention, les Banques centrales pourront augmenter la taille de leur bilan [...]. La différence est que la contrepartie comptable de ces émissions de monnaie centrale n'est pas nécessairement une dette, mais des réalisations d'activités extra financières labellisées, des activités non-marchandes essentielles, mais insolvables à court terme » [S1]. L'actif serait donc la prestation réalisée et certifiée.

::etat:: **La réponse du Cahier Technique est plus complète et c'est elle qu'il faut examiner.** Elle dédouble la contrepartie. « L'émission des NGDTS s'inscrit au passif du bilan du GES. Face à ce passif, deux contreparties apparaissent à l'actif [...]. La première est un **certificat de qualification régénérative** — attestation formelle par les collèges du GES que l'activité financée contribue effectivement à la restauration des communs. La seconde est une **créance sur les fontes futures** — droit à percevoir un flux futur de reflux monétaire remontant depuis les transactions ordinaires, à travers les banques centrales nationales, jusqu'au GES. Le certificat qualifie l'émission au moment présent. Les fontes futures assurent la clôture comptable du cycle dans le temps » [S2].
...
::etat:: **Une seconde objection, indépendante de la première, atteint la même créance, et elle est plus radicale.** Le référentiel de comptabilité publique écarte explicitement le cas : une intention de lever un prélèvement n'est pas un événement passé faisant naître un actif. **Un flux futur de fontes n'est donc pas reconnaissable comme créance**, non parce qu'il s'érode, mais parce qu'il n'a pas eu lieu. Et l'arbitrage sur le porteur aggrave ce point plutôt qu'il ne le lève, **mais la portée de cette aggravation doit être bornée.** L'arbitrage inscrit l'unité au passif de l'émetteur, la société supportant l'incidence économique **sans être débitrice en droit** (§ 1) ; or **une créance reconnaissable suppose un débiteur juridiquement identifiable.** Le corpus enregistre donc une tension — on ne peut pas simultanément n'avoir aucun débiteur en droit et détenir une créance reconnaissable — **et il la porte comme une objection à trancher, non comme une conséquence acquise.** **L10.C06 § 2 tient l'instruction de ce point** : la norme sur les produits vise nommément le mécanisme retenu par l'arbitrage et le déclare non comptabilisable, l'absence d'événement passé étant le motif et non une difficulté d'évaluation.

...
verifications_en_attente:
  ...
  - "Renvoi à ajouter vers L1.C04 (donut, limites planétaires, robustesse) quand il existera"
...
::etat:: À périmètre constant, les émissions mondiales de CO2 d'origine fossile sont passées de 22,7 gigatonnes en 1990 à 38,6 gigatonnes en 2024, soit une hausse de 70 % en trente-quatre ans. [S5] Sur la même période, l'année 1990 servait d'année de référence aux premiers accords climatiques.
...
::etat:: L'historien Jean-Baptiste Fressoz défend, dans un ouvrage de 2024, la thèse suivante : dans l'histoire humaine, les sources d'énergie ne se remplacent pas, elles s'additionnent. [S3]
...
::hypothese:: Si cette lecture est exacte, le mot de transition induit en erreur : il suggère un remplacement là où l'on observe un empilement, et laisse croire à une disparition spontanée des sources fossiles qu'aucun mécanisme historique connu ne produit. Des termes plus descriptifs — addition, empilement — rendraient mieux compte de ce qui est observé.
...
::etat:: La première est physique. Le second principe s'énonce pour un système isolé, or la Terre ne l'est pas : elle reçoit un flux solaire et rayonne vers l'espace. L'entropie locale peut donc décroître au prix d'une croissance de l'entropie globale, ce qui est précisément ce que fait le vivant. L'argument n'interdit donc pas toute organisation ; il impose que toute organisation soit payée par un flux entrant. Ce flux n'est pas fini au sens d'une quantité totale épuisable, mais limité en débit — la puissance reçue par unité de temps est bornée — et en fraction exploitable, puisque la conversion en travail utile suppose des dispositifs eux-mêmes coûteux en matière.
...
::etat:: Les trois constats qui suivent sont rapportés en l'état : leurs sources figurent parmi les vérifications en attente et aucun n'est encore établi dans ce corpus.
...
::etat:: Un découplage absolu au rythme requis par les objectifs climatiques ne serait pas observé au niveau mondial. Les cas nationaux qui s'en approchent appellent un examen en comptabilité par la consommation, c'est-à-dire en réattribuant au pays consommateur les émissions incorporées dans ses importations. Cette réattribution réduit l'ampleur du découplage constaté ; la part qu'elle en explique varie selon les pays et doit être mesurée, non postulée.
...
::etat:: **Ce qui est rapporté, sources à établir.** Un découplage relatif est observé dans les économies matures. Un découplage absolu au rythme requis ne le serait pas au niveau mondial, et les cas nationaux demandent un examen en comptabilité par la consommation.
...
::norme:: Ce qui en découle pour l'action ne relève donc pas du choix entre croissance et décroissance en général, mais de la réduction de l'intensité matérielle et du volume physique des productions qui n'apportent pas de bien-être. Et cette réorientation ne dépend pas de la technique disponible : elle dépend des règles qui déterminent ce qui est financé.

Le chapitre suivant examine le cadre proposé pour représenter l'espace dans lequel une économie peut se déployer — entre plancher social et plafond écologique.

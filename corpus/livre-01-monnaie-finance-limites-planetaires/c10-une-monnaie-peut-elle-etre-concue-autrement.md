...
Une dernière catégorie vient de l'intérieur du système. Depuis 2008, les banques centrales ont exploré des voies qui auraient été impensables auparavant. **L'une d'elles a fait coûter la détention de monnaie.** Le taux de la facilité de dépôt de l'Eurosystème est passé à −0,10 % le 11 juin 2014 [S23], et l'Eurosystème en est sorti le 21 juillet 2022 [S24]. **Le périmètre se lit avec la mesure** : le taux négatif portait sur les réserves excédentaires des banques, sur des dépôts publics au-delà de seuils et sur des comptes TARGET2 [S23] — non sur la monnaie du public. **Et le but n'était pas celui de Wörgl** : la Banque centrale européenne rattache ces décisions à son mandat de stabilité des prix et à une cible d'inflation de 2 % [S24], non à une règle de circulation. Ce n'est donc pas une monnaie fondante générale, et le chapitre ne l'écrit pas : c'est un coût de détention appliqué à une encaisse particulière, pour une autre raison. (*Image : une monnaie qui brûle les doigts — image du chapitre, non description du dispositif.*)

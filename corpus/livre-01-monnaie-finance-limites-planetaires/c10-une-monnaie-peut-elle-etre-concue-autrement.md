...
Les résultats rapportés sont considérables et ont fait le tour du monde. Selon Fisher [S2] et von Muralt [S16], le chômage local recule d'environ un quart en un an tandis qu'il augmente dans le reste de l'Autriche, les certificats circulent dix à quinze fois plus vite que le schilling, et une part importante des arriérés d'impôts locaux est résorbée — avec un encours effectif en circulation qui n'a jamais dépassé quelques milliers de schillings. La commune voisine de Kirchbichl imite Wörgl en janvier 1933 ; en juin 1933, Unterguggenberger s'adresse aux représentants de cent soixante-dix communes [S1]. Ces chiffres proviennent de la littérature contemporaine de l'expérience et n'ont pas été contrôlés ici sur données d'archives.
...
**Le Bristol Pound.** Monnaie locale complémentaire de la livre sterling, lancée en septembre 2012 à Bristol, à parité fixe garantie par une caisse de crédit coopératif, acceptée au plus fort par plus de huit cents commerces, avec pour objectif de retenir la richesse dans les circuits locaux. Elle a suspendu ses opérations numériques en 2020 et retiré ses billets en septembre 2021 [S20]. Elle a montré, pendant neuf ans, qu'une monnaie locale peut coexister avec la monnaie nationale sans en perturber le fonctionnement — et qu'elle peine à atteindre l'échelle qui la rendrait durable.
...
Si le diagnostic de L1.C09 tient, une monnaie conçue autrement devrait toucher les quatre règles à la fois — et satisfaire une condition que les expériences locales ont révélée en creux. Le chapitre pose le cahier des charges ; la seconde partie du livre en propose une réalisation.
...
La question n'est donc pas de savoir si une autre monnaie est possible : elle l'est, elle l'a été. La question est pourquoi celle-ci reste en place, et ce qu'il faudrait pour qu'une alternative porte cette fois sur les quatre règles à la fois. Avant d'y répondre, il faut regarder en face ce que le régime actuel produit de manière systématique, même sans intention de nuire : trois mécanismes inscrits dans son architecture, que le corpus nomme les malédictions monétaires. Les trois chapitres suivants les examinent l'un après l'autre.

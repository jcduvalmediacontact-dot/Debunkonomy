...
verifications_en_attente:
  ...
  - "CRITIQUE — « Plus de 7 000 milliards de dollars investis dans les fossiles par les grandes banques depuis 2016 » : source identifiée en L1.C11 — Banking on Climate Chaos 2026 : 8 700 Md$ sur 2016-2025, 65 banques, prêts et placements d'émissions (pas seulement du crédit). Aligner le chiffre et la formulation sur L1.C11 lors de la prochaine révision de ce chapitre."
  # — Données —
  - "Nombre d'États signataires de l'Accord de Paris et date exacte d'adoption"
  - "Évolution des émissions mondiales tous gaz entre 2015 et 2024 : la variation du CO2 fossile est établie [S1] ; celle du total des GES reste à établir dans le même périmètre"
  ...
  - "Autocitation : le texte source cite l'auteur à la troisième personne comme une référence extérieure. Reformulé ici en affirmation directe ; vérifier qu'aucune autre occurrence ne subsiste dans le corpus."
...
::etat:: Le montant des financements accordés aux énergies fossiles sur cette période est fréquemment chiffré dans le débat public. Aucune valeur n'est reprise ici tant qu'elle n'est pas rapportée à sa source, au périmètre des établissements retenus et à la définition du financement — prêt, souscription, participation.
...
::etat:: Les propositions techniques — énergies renouvelables, rénovation, mobilités, agriculture, recyclage — supposent un financement initial. La question de son origine est le plus souvent renvoyée à la volonté politique, c'est-à-dire à l'arbitrage budgétaire dont le chapitre premier a montré les limites.

::etat:: Les propositions réglementaires — tarification du carbone, normes, interdictions — augmentent le coût des productions les moins dommageables sans modifier les conditions d'accès au crédit des autres. Elles agissent sur le prix relatif, non sur l'allocation du financement.
...
::etat:: Des contre-exemples existent et sont importants. L'économie écologique a produit des travaux explicitement consacrés à la monnaie ; Herman Daly, l'un de ses fondateurs, défend une réforme du système bancaire dans le cadre de l'économie stationnaire ; Richard Douthwaite a publié en 1999 un ouvrage entièrement consacré à l'écologie de la monnaie ; la tradition des monnaies complémentaires, issue des travaux de Gesell, est ancienne et documentée. Nicholas Georgescu-Roegen lui-même, dont ce livre se réclame, appartient à ce champ.

::etat:: La thèse doit donc être restreinte pour être défendable : elle porterait sur la place de la question monétaire dans le discours écologiste dominant et dans les propositions portées par les organisations, non sur son absence de la littérature. Cette version restreinte demande à être établie par un examen de corpus, qui n'est pas conduit ici.

::hypothese:: Trois explications de cette place réduite peuvent être avancées, sans qu'aucune soit vérifiée. La première tient à la réputation technique de la matière, qui décourage l'appropriation. La deuxième tient à la segmentation des champs d'expertise, qui rend peu visibles les questions transversales. La troisième tient à ce qu'un mécanisme peu discuté est arbitré par un cercle restreint — effet, et non intention : rien ici n'établit qu'un acteur entretienne délibérément cette situation, et l'argument n'en a pas besoin.
...
::etat:: Des travaux allant dans ce sens existent, dans l'économie hétérodoxe, dans certaines organisations de plaidoyer et dans des publications de banques centrales consacrées au financement de la transition. Leur identification précise fait partie des vérifications en attente.

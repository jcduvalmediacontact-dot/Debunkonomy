...
::etat:: **LE JALON SUIVANT EST HUMAIN, ET IL EST NOMMÉ.** `protocoles/revue-comptable-a35b.md` pose cinq questions à un comptable national ou à un spécialiste des bilans de banque centrale. **Aucun modèle macroéconomique ne doit être entrepris avant cette revue** : le corpus a atteint une frontière où une boucle supplémentaire entre modèles déplacerait des conventions sans les valider.

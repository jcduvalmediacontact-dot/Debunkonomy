---
chapitre: L20.C02
titre: "L'interdiction du financement monétaire"
livre: 20
langue: fr
...
verifications_en_attente:
  ...
  # mécanisme pendant trois jours sans l'avoir tranché : ce chapitre le
  # tranche, et la réponse n'est pas celle que le corpus attendait.
  #
  # LE TEXTE A ÉTÉ LU, PAS RÉSUMÉ. Les deux prohibitions sont citées
  # verbatim depuis deux sources indépendantes — le traité et le protocole —
  # qui portent la même règle sous deux numéros différents.
  #
  - "TROIS NUMÉROTATIONS POUR UNE MÊME RÈGLE, et le corpus n'en détient que
     deux. Maastricht 1992 : **article 104**. Amsterdam 1997, tel que publié en
     2002 : **article 101**. Lisbonne 2007 : **article 123 TFUE**, celui que
     L1.C18 nomme. **Le corpus n'a pas ouvert la version Lisbonne** — il tient
     deux états antérieurs d'un texte dont il affirme lire le troisième."
  - "LA JURISPRUDENCE SUR CET ARTICLE N'EST PAS OUVERTE. Les arrêts qui ont
     déterminé la portée réelle de la prohibition — ce qui compte comme
     acquisition indirecte, à quelles conditions un achat sur le marché
     secondaire échappe à l'interdit — **ne sont pas au dossier**. Le corpus
     sait ce que l'article dispose ; **il ne sait pas ce qu'il a permis.**"
  - "LES STATUTS DES AUTRES BANQUES CENTRALES NE SONT PAS OUVERTS. La
     prohibition instruite ici est européenne. **Rien n'établit qu'elle
     existe ailleurs sous cette forme**, et le dispositif est mondial."
resume: "Ce chapitre tranche le verrou que le Livre 1 déclarait à trancher avant tout exposé du mécanisme d'émission et que le corpus n'avait pas tranché. Il cite verbatim, depuis deux sources indépendantes qui portent la même règle sous deux numéros différents, la prohibition du financement monétaire. Il établit d'abord que la prohibition est plus étroite que le corpus ne le supposait : elle vise les découverts, les crédits et l'acquisition directe d'instruments de dette au profit d'entités publiques nommément énumérées, et elle ne dit rien d'une émission qui ne serait le crédit de personne. Il établit ensuite que cette étroitesse ne libère pas le dispositif, mais déplace la question, parce que le prélèvement de reflux collectif qui finance l'institution et la contrepartie que l'émission inscrit tombent l'un et l'autre du côté public. Il relève que le paragraphe 2 du même article ouvre une exception pour les établissements publics de crédit traités comme les privés, ce qui montre que le critère retenu par le traité n'est pas la nature publique de l'entité mais l'égalité de traitement. Il établit enfin que le corpus ne détient pas la version en vigueur du texte, qu'il ne détient aucune jurisprudence sur sa portée, et qu'il ne détient les statuts d'aucune autre banque centrale, alors que le dispositif est mondial."
concepts: [creation_monetaire, contrepartie_comptable, reflux_collectif, fenetre_de_reforme]
renvois: [L1.C05, L1.C18, L1.C20, L1.C22, L7.C11, L7.C13, L11.C10, L20.C01]
---

# L'interdiction du financement monétaire

::etat:: Ce chapitre tranche ce que **L1.C18 § 6 déclarait à trancher avant tout exposé du mécanisme d'émission** [S3], et que le corpus n'a pas tranché avant d'exposer ce mécanisme sur soixante-dix-huit chapitres.

## 1. Le texte, verbatim, et il est plus étroit qu'on ne le suppose

::etat:: **Traité de Maastricht, article 104 § 1** [S1] : « Il est interdit à la BCE et aux banques centrales des États membres [...] d'accorder des **découverts ou tout autre type de crédit** aux institutions ou organes de la Communauté, aux administrations centrales, aux autorités régionales ou locales, aux autres autorités publiques, aux autres organismes ou entreprises publics des États membres ; **l'acquisition directe, auprès d'eux**, par la BCE ou les banques centrales nationales, **des instruments de leur dette** est également interdite. »

::etat:: **La même règle, dans le protocole sur les statuts, article 21.1** [S2], sous le numéro 101 — la prohibition y est reprise mot pour mot, et le paragraphe suivant précise que la banque centrale **peut agir comme agent financier** de ces mêmes entités.

::etat:: **Ce que le texte interdit est donc énumérable, et court** : le découvert, le crédit sous toute autre forme, et l'achat direct d'un titre de dette auprès de l'émetteur public. **Trois opérations, toutes de crédit, toutes bilatérales.**

## 2. Ce que le texte ne dit pas

::hypothese:: **La prohibition ne porte pas sur l'émission ; elle porte sur le crédit à une entité publique.** Une unité émise qui n'est **le crédit de personne** — sans échéance, sans débiteur, sans remboursement — **ne tombe sous aucun des trois termes énumérés**. Elle n'est ni un découvert, ni un autre type de crédit, ni l'acquisition d'un instrument de dette, **puisqu'il n'y a pas d'instrument de dette.**
...
::etat:: **L'énumération des bénéficiaires interdits est large là où l'énumération des opérations est étroite** : institutions et organes de la Communauté, administrations centrales, autorités régionales ou locales, « autres autorités publiques », « autres organismes ou entreprises publics ».

::hypothese:: **Le dispositif du corpus place deux objets de ce côté-là.** L'institution émettrice de L7 est un organisme public international ; le prélèvement de reflux collectif qui la finance (L7.C11) est un flux public. **Si l'émission ne finance pas une dette, elle finance en revanche des dépenses publiques par un canal que le traité surveille**, et la question devient celle de la qualification, non de la mécanique.

::hypothese:: **Il en résulte un déplacement, et le corpus le nomme comme tel : l'objection n'est pas écartée, elle change de terrain.** Elle passe de « ce que la banque centrale a le droit de faire » à « ce que l'unité émise est en droit » — un titre de créance, une réserve, un instrument sui generis. **Le corpus n'a jamais qualifié juridiquement l'unité NEMO.** C'est le blanc central de ce livre.

## 4. Le paragraphe 2 dit quel est le vrai critère

::etat:: **Le paragraphe 2 de l'article 104 excepte les établissements publics de crédit** qui, dans la mise à disposition de liquidités par les banques centrales, **bénéficient du même traitement que les établissements privés** [S1].

::hypothese:: **L'exception est instructive parce qu'elle révèle le critère.** Le traité n'interdit pas de servir une entité publique : **il interdit de la servir mieux.** Ce qui est prohibé est l'avantage, non le destinataire.

::hypothese:: **Le corpus tire de là une conséquence défavorable à sa propre lecture du § 2.** Si le critère est l'égalité de traitement, alors **une émission qui bénéficie à des projets qualifiés et à eux seuls est un traitement différencié par construction** — c'est même son objet, l'additionnalité (L1.C22). **La discrimination n'est pas un effet secondaire du dispositif : elle en est le principe.** Sous le critère du § 2, c'est un obstacle plus sérieux que la lettre du § 1.

## 5. Le corpus ne tient pas le texte en vigueur

::etat:: **Trois numérotations pour une même règle, et le corpus n'en détient que deux.** Maastricht 1992 : article 104. Amsterdam, tel que publié en 2002 : article 101. Lisbonne : **article 123 du traité sur le fonctionnement de l'Union européenne**, celui que L1.C18 nomme.

::etat:: **Le corpus n'a pas ouvert la version Lisbonne.** Il tient **deux états antérieurs** d'un texte dont il affirme lire le troisième. Rien n'indique que la substance ait changé — **et le corpus n'a pas vérifié qu'elle n'a pas changé.**

::etat:: **Il ne détient aucune jurisprudence sur cet article**, alors que la portée réelle d'une prohibition se lit dans ce qu'une juridiction a laissé passer.

::etat:: **Il ne détient les statuts d'aucune autre banque centrale.** La prohibition instruite ici est **européenne**, et le dispositif est mondial.

## 6. Portée

::etat:: **Le verrou est tranché sur la lettre, et la lettre est plus étroite que le corpus ne le supposait** : trois opérations de crédit, pas une prohibition d'émettre.

::hypothese:: **Cela ne libère pas le dispositif ; cela déplace l'objection sur un terrain où le corpus n'a rien** — la qualification juridique de l'unité émise, jamais faite en soixante-dix-huit chapitres.
...
::etat:: **CORRECTION DU 2026-09-07 (nuit), SUR REVUE CONTRADICTOIRE — l'annotation ci-dessus était trop forte.** **L'échappatoire de ce chapitre n'est pas « rétablie » : elle devient CONDITIONNELLE.** « Aucun débiteur individuel identifié » et « aucune obligation juridiquement opposable à une entité » **sont deux propositions différentes**, et l'arbitrage A35 décrit **l'incidence économique** de la charge, non son porteur en droit.

::etat:: **Conclusion exacte** : **si** les textes constitutifs du dispositif ne créent aucune créance opposable à une entité du secteur public, la branche sort du champ ; **si** une entité garantit, rembourse, convertit ou compense l'unité, **le test de l'article 123 doit être refait sur elle.** **Ce qui décide n'est ni l'instrument ni l'incidence : c'est l'existence d'une OBLIGATION OPPOSABLE**, et le corpus ne l'a établie dans aucun sens.

::etat:: **Aucune conclusion sur l'article 123 ne doit être propagée** avant qu'une **fiche de spécification de l'unité** soit écrite — droits du détenteur, obligations de l'émetteur, règle de conversion, extinction, détenteurs autorisés, **sort en cas de sortie d'un membre**.
